...
const variantClasses: Record<NonNullable<ButtonProps["variant"]>, string> = {
  ...
  secondary: "rounded-2xl border border-[var(--border)] bg-[var(--surface)] text-[var(--foreground)] hover:bg-[var(--surface-alt)] focus:ring-4 focus:ring-[var(--border)]",
  ghost: "rounded-2xl bg-transparent text-[var(--foreground)] hover:bg-[var(--surface-alt)] focus:ring-4 focus:ring-[var(--border)]",
}
