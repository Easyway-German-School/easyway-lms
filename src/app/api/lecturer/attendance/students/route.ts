    ...
    return NextResponse.json(
      roster.map((student) => {
        ...
        return {
          ...
          // Default PRESENT, not absent. The register submits the whole roster,
          // so an untouched student must not become absent just because the
          // tutor saved the register.
