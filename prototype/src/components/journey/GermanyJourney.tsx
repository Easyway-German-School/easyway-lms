  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-[#0D7C7E] via-[#0D7C7E] to-[#FF6600] px-5 py-5 text-white sm:px-7 sm:py-6">
      ...
      <div className="relative flex flex-wrap items-center gap-2">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/15 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.22em] text-white backdrop-blur">
          <MapIcon className="h-3.5 w-3.5" />
          {premium ? `${journey.currentLevel} private coaching journey` : "Your road to Germany"}
        </span>
        {journey.tribe ? (
          <span className="rounded-full border border-white/20 bg-white/15 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.22em] text-white backdrop-blur">
            {journey.tribe}
          </span>
        ) : null}
      </div>
      ...
      <button
        ...
        className="relative mt-3 inline-flex max-w-full items-center gap-2 rounded-full border border-white/20 bg-white/15 px-3 py-1.5 text-left text-[11px] font-bold text-white backdrop-blur transition hover:bg-white/25"
      >
