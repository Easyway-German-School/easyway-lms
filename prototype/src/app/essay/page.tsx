  ...
  return (
    <StudentShell>
      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:px-10">
        <header className="theme-dark rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-700 p-8 text-white shadow-2xl">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.35fr_0.85fr]">
          ...
          <aside className="theme-dark space-y-5 rounded-3xl bg-gradient-to-b from-slate-950 to-slate-800 p-6 text-slate-50 shadow-2xl ring-1 ring-white/10">
            <div>
