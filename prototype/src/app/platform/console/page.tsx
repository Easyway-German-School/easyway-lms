 ...
 * they may not have.
 *
 * Lives at `/platform/console`, not `/admin/platform`: this screen manages
 * every school on the system, EasyWay included, so it does not wear EasyWay's
 * own admin chrome — it wears EduPrime's, the platform's own brand. `/platform`
 * itself is now the EduPrime marketing site. See PlatformShell.
 */
